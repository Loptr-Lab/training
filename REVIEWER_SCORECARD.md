...
### Gate outcome
- **Pass**: Both mandatory suites pass, or any discrepancy is clearly justified in `NOTES.md` with coherent technical reasoning.
- **Fail**: Either mandatory suite fails without strong, explicit justification.
